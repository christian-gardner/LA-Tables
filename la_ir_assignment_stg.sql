ALTER TABLE LA_IR_ASSIGNMENT_STG
 DROP PRIMARY KEY CASCADE;

DROP TABLE LA_IR_ASSIGNMENT_STG CASCADE CONSTRAINTS;

CREATE TABLE LA_IR_ASSIGNMENT_STG
(
...
--  There is no statement for index RDM.SYS_C0052654.
--  The object is created when the parent object is created.

ALTER TABLE LA_IR_ASSIGNMENT_STG ADD (
  PRIMARY KEY
  (LOAD_ID)
  ENABLE VALIDATE);

GRANT DELETE, INSERT, SELECT, UPDATE ON LA_IR_ASSIGNMENT_STG TO IPP$LIBRARIAN;
