ALTER TABLE LA_IR_ASSIGNMENT_AUD
 DROP PRIMARY KEY CASCADE;

DROP TABLE LA_IR_ASSIGNMENT_AUD CASCADE CONSTRAINTS;

CREATE TABLE LA_IR_ASSIGNMENT_AUD
(
...
--  There is no statement for index RDM.SYS_C0052653.
--  The object is created when the parent object is created.

ALTER TABLE LA_IR_ASSIGNMENT_AUD ADD (
  PRIMARY KEY
  (LOAD_ID)
  ENABLE VALIDATE);
