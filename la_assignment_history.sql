ALTER TABLE LA_ASSIGNMENT_HISTORY
 DROP PRIMARY KEY CASCADE;

DROP TABLE LA_ASSIGNMENT_HISTORY CASCADE CONSTRAINTS;

CREATE TABLE LA_ASSIGNMENT_HISTORY
(
...
--  There is no statement for index RDM.SYS_C0052637.
--  The object is created when the parent object is created.

ALTER TABLE LA_ASSIGNMENT_HISTORY ADD (
  PRIMARY KEY
  (PID)
  ENABLE VALIDATE);
