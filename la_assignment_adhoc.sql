ALTER TABLE LA_ASSIGNMENT_ADHOC
 DROP PRIMARY KEY CASCADE;

DROP TABLE LA_ASSIGNMENT_ADHOC CASCADE CONSTRAINTS;

CREATE TABLE LA_ASSIGNMENT_ADHOC
(
...
CREATE UNIQUE INDEX LA_ASSIGNMENT_ADHOC_PK01 ON LA_ASSIGNMENT_ADHOC
(DISPUTE_ID)
LOGGING
NOPARALLEL;


ALTER TABLE LA_ASSIGNMENT_ADHOC ADD (
  CONSTRAINT LA_ASSIGNMENT_ADHOC_PK01
  PRIMARY KEY
  (DISPUTE_ID)
  USING INDEX LA_ASSIGNMENT_ADHOC_PK01
  ENABLE VALIDATE);
