ALTER TABLE LA_DATA_ENTRY
 DROP PRIMARY KEY CASCADE;

DROP TABLE LA_DATA_ENTRY CASCADE CONSTRAINTS;

CREATE TABLE LA_DATA_ENTRY
(
...
CREATE UNIQUE INDEX LA_DATA_ENTRY_PK01 ON LA_DATA_ENTRY
(DISPUTE_ID)
LOGGING
NOPARALLEL;


ALTER TABLE LA_DATA_ENTRY ADD (
  CONSTRAINT LA_DATA_ENTRY_PK01
  PRIMARY KEY
  (DISPUTE_ID)
  USING INDEX LA_DATA_ENTRY_PK01
  ENABLE VALIDATE);

GRANT DELETE, INSERT, SELECT, UPDATE ON LA_DATA_ENTRY TO RDM_RW;
